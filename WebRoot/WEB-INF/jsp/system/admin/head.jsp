<div class="navbar navbar-inverse">
	<div class="navbar-inner">
		<div class="container-fluid">
			<a class="brand"><small><i class="icon-leaf"></i>后台管理系统</small> </a>
			<ul class="nav ace-nav  pull-right">
				<li class="light-blue user-profile">
					...
					<ul id="user_menu" class="pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
						<li><a onclick="editUserH();" style="cursor:pointer;"><i class="icon-user"></i> 修改登录密码</a></li>
						<li><a onclick="updatePayPassword();" style="cursor:pointer;"><i class="icon-user"></i> 修改支付密码</a></li>
						<li class="divider"></li>

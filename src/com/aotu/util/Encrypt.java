...
public class Encrypt {
	...
	public static String md5(String password, String salt){
		return new Md5Hash(new Md5Hash(password, salt, 1).toString()).toString();
	}
	
	public static void main(String[] args) {
		System.out.println( new Md5Hash(new Md5Hash(SysConstant.CURRENT_USER_PASSWORD, "15959341528", 1).toString()));
	}

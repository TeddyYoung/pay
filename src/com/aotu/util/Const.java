...
public class Const {
	...
	public static final String SESSION_DEPT = "sessionDept";
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(payback)|(app)|(static)|(main)).*";	//不对匹配该值的访问路径拦截（正则）
